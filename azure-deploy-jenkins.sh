...
LOCATION="eastus"
STORAGE_ACCOUNT="reportjenkinsstoredhl"
FILE_SHARE="jenkins-data"
ACR_NAME="reportjenkinsacrdhl"
CONTAINER_NAME="jenkins-research-reportdhl"
DNS_NAME_LABEL="jenkins-research-$(date +%s | tail -c 6)dhl"
...
SUBSCRIPTION_ID="${1:-${AZURE_SUBSCRIPTION_ID}}"Dockerfile.jenkins
